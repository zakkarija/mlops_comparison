...
import numpy as np
import pandas as pd
from classes import preprocessing_functions as preprocessing_functions
...
# To equal the length of the signals add padding (add zeros or nans at th e end of the series).
