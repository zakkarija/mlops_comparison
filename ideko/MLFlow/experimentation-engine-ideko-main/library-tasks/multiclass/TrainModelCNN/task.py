...
from classes.multiclass_models import ConvolutionalNeuralNetwork
...
n_timestamps, n_features, n_classes = ph.load_datasets(variables, "Timestamps", "Features", "n_classes")
...
ph.save_datasets(variables, ("Timestamps", n_timestamps), ("Features", n_features), ("n_classes", n_classes))
