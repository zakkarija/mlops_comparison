...
def read_data(data_path, indicator_list):
    ...
    Returns:
        ...
        Y: list of labels (0: not anomalous data / 1: anomalous data)
    '''
    ...
    #TODO note: I had to add the labels like this for reading the data
    labels = {
        "not_anomalous": 0,
    ...
    #TODO note: This whole loop has been changed to read new data folders structure
