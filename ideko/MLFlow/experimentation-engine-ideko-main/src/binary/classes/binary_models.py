...
from tensorflow.keras.layers import Masking, Dense, Flatten, Conv1D, MaxPooling1D, SimpleRNN, LSTM
...
class NeuralNetwork(ModelConfiguration):
    def __init__(self, n_timestamps, n_features, activation_function, units):
    ...
    def create_model(self):
        ...
        # Last layer with one neuron and sigmoid activation function.
        # Returns the probability of an observation belonging to the positive class.
...
class ConvolutionalNeuralNetwork(ModelConfiguration):
    def __init__(self, n_timestamps, n_features, activation_function, filters, kernel_size, pool_size):
...
class RecurrentNeuralNetwork(ModelConfiguration):
    def __init__(self, n_timestamps, n_features, activation_function, hidden_units):
