...
from classes.binary_models import NeuralNetwork, ConvolutionalNeuralNetwork, RecurrentNeuralNetwork, LongShortTermMemory
...
if enabled_cnn:
    ...
    # Model evaluation
    model_cnn.model_evaluation(model_cnn.model, X_pad, Y_pad, X_test, y_test)
...
if enabled_lstm:
    ...
    # Initialise the model class
    model_lstm = LongShortTermMemory(n_timestamps, n_features, activation_function, hidden_units)
    ...
    # Model evaluation
    model_lstm.model_evaluation(model_lstm.model, X_pad, Y_pad, X_test, y_test)
